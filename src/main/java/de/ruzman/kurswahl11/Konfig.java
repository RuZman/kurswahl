...
public enum Konfig {
	...
	// Zustandsoptionen:
	INHALT_WAHLPFLICHT, INHALT_SPORT, ZUSTAND_CHKRELIGION, ZUSTAND_RELIGION, INHALT_RELIGION, ZUSTAND_FREMD, ZUSTAND_ZUSATZ2;
	...
	public void initalisiere() {
		 ...
		 */
		einstellung = Konfiguration.gibInstanz("konfig11.ini").gibZeile(this.ordinal());
	}
