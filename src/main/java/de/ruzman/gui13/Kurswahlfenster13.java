 ...
 * @version 1.0.0
 */
public class Kurswahlfenster13 extends Kurswahlfenster {
	private Login login1;
	private Kurswahl kurswahl1;
	private Bestaetigung bestaetigung1;

	static {
		jahrgang = new DBJahrgang(new DBSchueler13());
	}

	/**
	 * Konstruktor der Klasse Kurswahlfenster.
	 */
	public Kurswahlfenster13() {
		initialisiere();
	}
	...
	private void initialisiere() {
		...
		login1 = new Login("Kurswahl13 - Login");
	...
	private void initComponents() {
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jLayeredPane, javax.swing.GroupLayout.DEFAULT_SIZE, 419, Short.MAX_VALUE));
