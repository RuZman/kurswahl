 ...
 * seine Kurse wählen zu können. Für die Kurswahl wird eine Datenbankverbindung
 * vorrausgesetzt.
 *
...
public class Kurswahl extends javax.swing.JPanel implements Erneuerbar
{
    ...
    private de.ruzman.kurswahl13.DBSchueler schueler;
    ...
    private void initialisiere()
    {
        ...
        Kurswahlfenster.loescheUndSetzeComboBox(cbErstwahl,
            "-Auswählen-", de.ruzman.kurswahl13.Konfig.INHALT_SPORT
            .toString().split(","), true);

        // Legt den Inhalt für die Combobox ZweitwahlSport fest:
        Kurswahlfenster.loescheUndSetzeComboBox(cbZweitwahl,
            "-Auswählen-", de.ruzman.kurswahl13.Konfig.INHALT_SPORT
            .toString().split(","), true);
        
        // Legt den Inhalt für die Combobox ErstwahlSport fest:
        Kurswahlfenster.loescheUndSetzeComboBox(cbWahlpflicht,
            "-Auswählen-", de.ruzman.kurswahl13.Konfig.INHALT_WAHLPFLICHT
            .toString().split(","), true);
    }
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(laZweitwahl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(laErstwahl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbErstwahl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(laErstwahl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(laZweitwahl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cbZweitwahl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbWahlpflicht, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbWahlpflicht, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        chbWahlpflicht.setText("<html><b>Ich habe bereits den Wahlpflichtkurs<br> in der 12. Klasse belegt und möchte<br> keinen mehr.</b></html>");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(chbWahlpflicht, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(laSternchenkurs, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(laSprachen1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(chbWahlpflicht, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
     ...
     *
     * @param evt Eingehendes Event bei buAbbrechenAction
     */
     ...
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbSpanisch_fort
     */
     ...
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbFranz_fort
     */
     ...
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbGeschichte3z2
     */
     ...
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbGeschichte2zu3
     */
    ...
    /**
     * Deselektiert die Auswahl chbPoWi2z3, da die gemeinsame Kombination
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbPoWi3zu2A
     */
     ...
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbPoWi2z3
     */
     ...
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbReligion_kat
     */
     ...
     * nicht möglich ist.
     *
     * @param evt Eingehendes Event bei chbReligion_evang
     */
     ...
     * freigeschalten.
     *
     * @param evt Eingehendes Event bei chbPoWi
     */
    ...
    /**
     * Deselektiert die Auswahl chbPoWi, da die gemeinsame Kombination
     * nicht möglich ist.Zudem wird dem Schüler eine Umwahl der Stunden
     * freigeschalten.
     *
     * @param evt Eingehendes Event bei chbPoWi_bili
     */
     ...
     *
     * @param evt Eingehendes Event bei buSpeichern
     */
    private void buSpeichernActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buSpeichernActionPerformed
        // Überprüft, ob ein Sternchenkurs schon belegt oder grade gewählt wurde:
        if((chbWahlpflicht.isSelected() || chbPoWi.isSelected() || chbPoWi_bili.isSelected()
                || chbRewe.isSelected() || chbDaten.isSelected() || (chbWahlpflicht.isSelected()) 
                || !"-Auswählen-".equals(cbWahlpflicht.getSelectedItem()))
                && (!(((String)cbErstwahl.getSelectedItem()).equals("-Auswählen-"))
                && !(((String)cbZweitwahl.getSelectedItem()).equals("-Auswählen-"))
                || !jPanel4.isVisible()))
        {
            ...
            schueler.update(chbPoWi.isSelected(), chbPoWi_bili.isSelected(), (String)cbWahlpflicht.getSelectedItem(),
                             chbRewe.isSelected(), chbDaten.isSelected(), chbGeschichte3z2.isSelected(), chbGeschichte2zu3.isSelected(), chbPoWi3zu2.isSelected(),
                             chbPoWi2z3.isSelected(), chbReligion_kat.isSelected(), chbReligion_evang.isSelected(),  (String)cbErstwahl.getSelectedItem(), (String)cbZweitwahl.getSelectedItem(),
                             chbWahlpflicht.isSelected(), (String)cbReligion.getSelectedItem(), tfZusatzKurs.getText(), tfAbwahlKurs.getText(), hatFremdsprache, hatFremdspracheIn13);
            // Nächstes Panel:
            this.setVisible(false);
     ...
     *
     * @param evtEingehendes Event bei cbErstwahl
     */
    private void cbErstwahlActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbErstwahlActionPerformed
        ...
        {
            if(((String)cbErstwahl.getSelectedItem()).equals("-Auswählen-") &&
                    !cbZweitwahl.isEnabled())
            {
     ...
     *
     * @param fenster Referenz zum Kurswahlfenster.
     */
    ...
    public void zuruecksetzen()
    {
        ...
        if((de.ruzman.kurswahl13.Konfig.ZUSTAND_CHKRELIGION.toString())
                .equalsIgnoreCase("AN"))
        {
        ...
        if(de.ruzman.kurswahl13.Konfig.ZUSTAND_RELIGION.toString()
                .equalsIgnoreCase("AN"))
        {
            // Combobox anzeigen:
            ...
            Kurswahlfenster.loescheUndSetzeComboBox(cbReligion,
                    de.ruzman.kurswahl13.Konfig.INHALT_RELIGION.toString().split(","));
        }
        else
        {
        ...
        if(de.ruzman.kurswahl13.Konfig.ZUSTAND_ZUSATZ1.toString()
                .equalsIgnoreCase("AN"))
        {
        ...
        if(de.ruzman.kurswahl13.Konfig.ZUSTAND_ZUSATZ2.toString()
                .equalsIgnoreCase("AN"))
        {
        ...
        boolean istSportkursAktiv = de.ruzman.kurswahl13.Konfig.ZUSTAND_SPORTWAHL.toString()
                .equalsIgnoreCase("AN");
